...
class CasesActivityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text("صفحة القضايا - مؤقتة")),
    );
  }
}
...
class LoginActivityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text("صفحة عمليات تسجيل الدخول - مؤقتة")),
    );
  }
}
...
class EditsActivityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text("صفحة التعديلات - مؤقتة")),
    );
  }
}
